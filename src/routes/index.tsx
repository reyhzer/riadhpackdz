    ...
    <div className="min-h-screen" style={{ fontFamily: 'Open Sans, sans-serif' }}>
      ...
      >
        ...
        <div className="absolute bottom-10 left-1/2 -translate-x-1/2 animate-bounce">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="rgba(255,255,255,0.7)" className="w-7 h-7">
      ...
      <section id="apropos" className="relative py-28 overflow-hidden">
        <div className="relative z-10 max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-20 items-center">
            ...
            {/* Right Side - Image */}
            <div 
              className="relative opacity-0 translate-y-12 transition-all duration-1000 ease-out delay-300"
              id="about-image"
            >
